select conname as "Constraint Name", pg_class.relname as "Owner", 
    case pg_constraint.contype when 'f' then 'FOREIGN KEY' when 'c' then 'CHECK' when 'u' then 'UNIQUE' when 'p' then 'PRIMARY KEY' else '' end as "Type", 
